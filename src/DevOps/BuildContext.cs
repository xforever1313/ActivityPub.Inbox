...
namespace DevOps
{
    public class BuildContext : FrostingContext
    {
            ...
            base( context )
        {
            ...
            this.Solution = this.SrcDir.CombineWithFilePath( "ActivityPub.Inbox.sln" );
            ...
            this.TestCsProj = this.SrcDir.CombineWithFilePath( "ActivityPub.Inbox.Tests/ActivityPub.Inbox.Tests.csproj" );
        }
